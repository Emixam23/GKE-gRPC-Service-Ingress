...
func request_GKEgRPCService_Test_0(ctx context.Context, marshaler runtime.Marshaler, client GKEgRPCServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func local_request_GKEgRPCService_Test_0(ctx context.Context, marshaler runtime.Marshaler, server GKEgRPCServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq TestRequest
	var metadata runtime.ServerMetadata
...
func RegisterGKEgRPCServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server GKEgRPCServiceServer) error {
	...
	mux.Handle("GET", pattern_GKEgRPCService_Test_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_GKEgRPCService_Test_0(rctx, inboundMarshaler, server, req, pathParams)
		...
		forward_GKEgRPCService_Test_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterGKEgRPCServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client GKEgRPCServiceClient) error {
	...
	mux.Handle("GET", pattern_GKEgRPCService_Test_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_GKEgRPCService_Test_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_GKEgRPCService_Test_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0}, []string{"test"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_GKEgRPCService_HelloWorld_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0}, []string{"hello_world"}, "", runtime.AssumeColonVerbOpt(true)))
)

var (
	forward_GKEgRPCService_Test_0 = runtime.ForwardResponseMessage
